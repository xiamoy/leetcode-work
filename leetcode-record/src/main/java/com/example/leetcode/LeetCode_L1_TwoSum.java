...
public class LeetCode_L1_TwoSum {
    public static void main(String[] args) {
        ...
        Solution_L1 solution_l1 = new Solution_L1();
        int[] case1 = new int[]{2, 7, 11, 15};
        int[] twoSum1 = solution_l1.twoSum(case1, 9);//[0,1]
        int[] case2 = new int[]{0, 4, 3, 0};
        int[] twoSum2 = solution_l1.twoSum(case2, 0);//[0,3]
        System.out.println(twoSum2);
        int[] case3 = new int[]{-1, -2, -3, -4, -5};
        int[] twoSum3 = solution_l1.twoSum(case2, -8);//[2,4]

        int[] case4 = new int[]{3, 3};
        int[] twoSum4 = solution_l1.twoSumN2(case4, 6);//[0,1]
        System.out.println(twoSum4);

        int[] case5 = new int[]{3, 2, 4};
        int[] twoSum5 = solution_l1.twoSumN2(case5, 6);//[1,2]
